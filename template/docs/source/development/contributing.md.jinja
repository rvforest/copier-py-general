...
Thank you for your interest in contributing to {{ project_name }}! This guide outlines project-specific requirements and workflows.

## Setting Up Your Development Environment

### Prerequisites

- Python {{ py_min_version }} or higher
- Git
- A GitHub account
...
If you need help with contributing to {{ project_name }}, you can:
